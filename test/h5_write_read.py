...
def run_write_read(file_name):
    ...
    hdf_write = h5py.File(file_name, 'w')
    ...
    print(f"Reading datasets {dataset_names} ")
...
def run_read(file_name, num_datasets):
    ...
    # with h5py.File(file_name, mode='r', swmr=False) as hdf_file:
        # datasets = list(hdf_file.keys())
        # print(f"Reading datasets {datasets} ")
        # print(f"hdf_file {hdf_file}")
        
        # for i in range(num_datasets):
        #     data = hdf_file[f'dataset{i}'][...]
